package asia.health.bitcare.bt;
...
/**
 * Created by farid on 2017-06-08.
 */

public class BtService {
    // Debugging
    private static final String TAG = "Pumpkin";
    ...
    public void write(byte[] out) {
        Log.d("Pumpkin", "BtService write()");
        ConnectedThread r;
        // Synchronize a copy of the ConnectedThread
        synchronized (this) {
            if (mState != STATE_CONNECTED) {
                Log.d("Pumpkin", "mState != STATE_CONNECTED");
                return;
            }
            r = mConnectedThread;
        }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.d("Pumpkin", "Close the socket!!!!!!!!! " + e.toString());
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            try {
                ...
                Log.d(TAG, "ConnectedThread Get Stream!!");
            } catch (IOException e) {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                Log.d(TAG, "ConnectedThread run() mState == STATE_CONNECTED");
                try {
                    // Read from the InputStream
                    bytes = mmInStream.read(buffer);

                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(BtConstants.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                Log.d("Pumpkin", "BtServie write() - 2");
